...
void CaptionPluginManager::update_settings(const CaptionPluginSettings &new_settings) {
    ...
    info_log("enabled: %d, is_live %d, is_streaming_relevant: %d, is_recording %d, is_recording_relevant: %d,"
             ...
             new_settings.enabled, state.external_is_streaming, is_streaming_relevant, state.external_is_recording, is_recording_relevant,
             state.external_is_preview_open, 0, source_settings.caption_source_settings.caption_source_name.c_str());
